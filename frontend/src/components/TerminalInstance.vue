...
import { StartSession, WriteToTerminal, ResizeTerminal, KillSession } from '../../wailsjs/go/main/TerminalService';
...
onMounted(async () => {
  ...
  term = new Terminal({
    ...
    fontFamily: 'SFMono-Regular, Consolas, Menlo, Monaco, "Liberation Mono", "Courier New", monospace',
    theme: props.theme,
    cursorBlink: true,
    cursorStyle: 'block',
    cursorWidth: 2,
...
:deep(.xterm-viewport) {
  --scrollbar-thumb: var(--terminal-scrollbar-thumb, rgba(255, 255, 255, 0.15));
