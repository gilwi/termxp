      ...
      <div class="sidebar-content custom-scrollbar">
          ...
          <div class="metrics-grid">
            <div class="metric-card">
              ...
              <div class="progress-bar-container">
                <div class="progress-bar cpu-bar" :style="{ width: stats.cpu + '%' }"></div>
              </div>
            </div>
            ...
            <div class="metric-card">
              <div class="metric-info">
                <span>RAM Usage</span>
                <span class="metric-value">{{ stats.memory }}%</span>
              </div>
              <div class="progress-bar-container">
                <div class="progress-bar memory-bar" :style="{ width: stats.memory + '%' }"></div>
              </div>
            </div>
        ...
        <section class="section">
          ...
          <div class="themes-grid">
            <button
              ...
              :key="themeKey"
              :class="['theme-btn', { active: currentTheme === themeKey }]"
              @click="currentTheme = themeKey"
            >
              <span class="theme-color-dot" :style="{ background: themeConfig.xterm.background }"></span>
              {{ themeConfig.name }}
            </button>
          </div>
        </section>
        ...
        <section class="section">
          ...
          <div class="font-controls">
            <button @click="fontSize = Math.max(10, fontSize - 1)" class="font-btn">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <line x1="5" y1="12" x2="19" y2="12"></line>
              </svg>
            </button>
            <span class="font-display">{{ fontSize }}px</span>
            <button @click="fontSize = Math.min(24, fontSize + 1)" class="font-btn">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <main class="workspace">
      ...
      <header class="top-header">
        <div class="tabs-scroll-container custom-scrollbar">
          ...
          <button class="icon-toggle-btn" @click="sidebarOpen = !sidebarOpen" title="Toggle Sidebar">
          ...
          <div class="tabs-list">
            ...
            <!-- Add Tab Button -->
            <button class="add-tab-btn" @click="addTab" title="Open new shell session">
      ...
      <div class="terminal-workspace-container">
        ...
        <div v-if="tabs.length === 0" class="empty-state">
          ...
          <div class="empty-info">
            ...
            <p>Spawns local terminal processes (e.g. bash) on your host machine to run CLI actions.</p>
...
.bg-glow {
  ...
  width: 60%;
  height: 60%;
  background: radial-gradient(circle, var(--active-accent-glow) 0%, transparent 70%);
  z-index: 0;
  pointer-events: none;
  filter: blur(80px);
}
